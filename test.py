...
# Set variables here
length = 35e-6                      # Length of the NR (m)
width = 2.3e-6                        # Width of the NR (m)
...
k_CdS = 0.0368                   # Estimated refractive index imag part (532 nm)
...
sampleRate = 100                     # Spatial sample rate
numSum = 15                          # Eigenvalue sample rate
lambda0 = 532e-9                    # laser wavelength (m)
laser_power = 0.1                     # Laser power in milliwatts
